...
enum {
	HISTORY_EXPRESSION_TYPE_PARSED,
	HISTORY_EXPRESSION_TYPE_ENTERED,
	HISTORY_EXPRESSION_TYPE_ENTERED_AND_PARSED,
	HISTORY_EXPRESSION_TYPE_PARSED_COMPACT,
	HISTORY_EXPRESSION_TYPE_ENTERED_AND_PARSED_COMPACT
};
...
typedef enum {
	...
	SHORTCUT_TYPE_TOGGLE_FRACTION
} shortcut_type;

#define LAST_SHORTCUT_TYPE SHORTCUT_TYPE_TOGGLE_FRACTION
...
class QalculateQtSettings : QObject {
	...
	public:
		...
		bool custom_digit_grouping, custom_digit_group_changed;
		std::string custom_digit_group_separator, custom_digit_group_format, saved_local_dgs, saved_local_dgf;
